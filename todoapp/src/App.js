...
function App() {
  ...
  // const [updatingListItemId, setUpdatingListItemId] = useState('');
    ...
    <div className="appcontainer">
      <div className="flex flex-col justify-center p-3 text-center m-2 mt-8 pb-8 rounded">
        ...
        <div className="mt-16 mb-16 flex gap-0.5 justify-center overflow-auto">
          <input value={listInput} type="text" className="w-4/12 border rounded mr-1 p-1" placeholder=" List Name " onChange={listInputHandler} onKeyDown={ keyEventHandler}/>
          { !!!listItemUpdate && 
